...
// include: ..\..\src\temp_preload_download.js
// This language is mad, so operating on a bit of trust from our friend Mr. GPT here...
// Module = Module || {};
Module.onRuntimeInitialized = async () => {
  await fetchToFs("https://dl.dropboxusercontent.com/scl/fi/78p8ocxnlyt7vzr8mhi77/point_cloud.ply?rlkey=1gtp2kmtk6x92lrm729xgx6t1&st=1frvhb1u&dl=1", "point_cloud.ply");
  Module._main();
};
...
async function fetchToFs(url, path) {
  ...
  if (!response.ok) {
    console.error("Failed to fetch .ply file from internet! :(");
    return;
  }
  const buffer = await response.arrayBuffer();
  const bytes = new Uint8Array(buffer);
  FS.writeFile(path, bytes);
  console.log("Wrote .ply file");
}

// end include: ..\..\src\temp_preload_download.js
var arguments_ = [];
...
var _wgpuDeviceCreateTexture = (devicePtr, descriptor) => {
  var desc = {
    ...
    "dimension": WebGPU.TextureDimension[HEAPU32[(((descriptor) + (24)) >> 2)]],
    "format": WebGPU.TextureFormat[HEAPU32[(((descriptor) + (40)) >> 2)]],
    "usage": HEAPU32[(((descriptor) + (16)) >> 2)]
  };
...
var _main, _emwgpuCreateBindGroup, _emwgpuCreateBindGroupLayout, _emwgpuCreateCommandBuffer, _emwgpuCreateCommandEncoder, _emwgpuCreateComputePassEncoder, _emwgpuCreateComputePipeline, _emwgpuCreatePipelineLayout, _emwgpuCreateQuerySet, _emwgpuCreateRenderBundle, _emwgpuCreateRenderBundleEncoder, _emwgpuCreateRenderPassEncoder, _emwgpuCreateRenderPipeline, _emwgpuCreateSampler, _emwgpuCreateSurface, _emwgpuCreateTexture, _emwgpuCreateTextureView, _emwgpuCreateAdapter, _emwgpuCreateBuffer, _emwgpuCreateDevice, _emwgpuCreateQueue, _emwgpuCreateShaderModule, _emwgpuOnDeviceLostCompleted, _emwgpuOnRequestAdapterCompleted, _emwgpuOnRequestDeviceCompleted, _emwgpuOnWorkDoneCompleted, _emwgpuOnUncapturedError, _free, _malloc, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, dynCall_viiiii, dynCall_viii, dynCall_iiii, dynCall_vi, dynCall_viiii, dynCall_ii, dynCall_viji, dynCall_jiji, dynCall_viiiiii, _asyncify_start_unwind, _asyncify_stop_unwind, _asyncify_start_rewind, _asyncify_stop_rewind, memory, __indirect_function_table, wasmMemory;

function assignWasmExports(wasmExports) {
  _main = Module["_main"] = wasmExports["ga"];
  _emwgpuCreateBindGroup = wasmExports["ha"];
  _emwgpuCreateBindGroupLayout = wasmExports["ia"];
  _emwgpuCreateCommandBuffer = wasmExports["ja"];
  _emwgpuCreateCommandEncoder = wasmExports["ka"];
  _emwgpuCreateComputePassEncoder = wasmExports["la"];
  _emwgpuCreateComputePipeline = wasmExports["ma"];
  _emwgpuCreatePipelineLayout = wasmExports["na"];
  _emwgpuCreateQuerySet = wasmExports["oa"];
  _emwgpuCreateRenderBundle = wasmExports["pa"];
  _emwgpuCreateRenderBundleEncoder = wasmExports["qa"];
  _emwgpuCreateRenderPassEncoder = wasmExports["ra"];
  _emwgpuCreateRenderPipeline = wasmExports["sa"];
  _emwgpuCreateSampler = wasmExports["ta"];
  _emwgpuCreateSurface = wasmExports["ua"];
  _emwgpuCreateTexture = wasmExports["va"];
  _emwgpuCreateTextureView = wasmExports["wa"];
  _emwgpuCreateAdapter = wasmExports["xa"];
  _emwgpuCreateBuffer = wasmExports["ya"];
  _emwgpuCreateDevice = wasmExports["za"];
  _emwgpuCreateQueue = wasmExports["Aa"];
  _emwgpuCreateShaderModule = wasmExports["Ba"];
  _emwgpuOnDeviceLostCompleted = wasmExports["Ca"];
  _emwgpuOnRequestAdapterCompleted = wasmExports["Da"];
  _emwgpuOnRequestDeviceCompleted = wasmExports["Ea"];
  _emwgpuOnWorkDoneCompleted = wasmExports["Fa"];
  _emwgpuOnUncapturedError = wasmExports["Ga"];
  ...
  dynCall_viiiii = dynCalls["viiiii"] = wasmExports["Ma"];
  dynCall_viii = dynCalls["viii"] = wasmExports["Na"];
  dynCall_iiii = dynCalls["iiii"] = wasmExports["Oa"];
  dynCall_vi = dynCalls["vi"] = wasmExports["Pa"];
  dynCall_viiii = dynCalls["viiii"] = wasmExports["Qa"];
  dynCall_ii = dynCalls["ii"] = wasmExports["Ra"];
  dynCall_viji = dynCalls["viji"] = wasmExports["Sa"];
  dynCall_jiji = dynCalls["jiji"] = wasmExports["Ta"];
  dynCall_viiiiii = dynCalls["viiiiii"] = wasmExports["Ua"];
  _asyncify_start_unwind = wasmExports["Va"];
  _asyncify_stop_unwind = wasmExports["Wa"];
  _asyncify_start_rewind = wasmExports["Xa"];
  _asyncify_stop_rewind = wasmExports["Ya"];
...
var wasmImports = {
  ...
  /** @export */ _: __abort_js,
  /** @export */ Z: __emscripten_get_last_mouse_event,
  /** @export */ ba: _clock_time_get,
  /** @export */ Y: _emscripten_has_asyncify,
  /** @export */ X: _emscripten_request_pointerlock,
  /** @export */ W: _emscripten_resize_heap,
  /** @export */ V: _emscripten_set_fullscreenchange_callback_on_thread,
  /** @export */ U: _emscripten_set_keydown_callback_on_thread,
  /** @export */ T: _emscripten_set_keyup_callback_on_thread,
  /** @export */ S: _emscripten_set_main_loop_arg,
  /** @export */ R: _emscripten_set_mousedown_callback_on_thread,
  /** @export */ Q: _emscripten_set_mousemove_callback_on_thread,
  /** @export */ P: _emscripten_set_mouseup_callback_on_thread,
  /** @export */ O: _emscripten_set_pointerlockchange_callback_on_thread,
  /** @export */ N: _emscripten_set_pointerlockerror_callback_on_thread,
  /** @export */ M: _emscripten_set_resize_callback_on_thread,
  /** @export */ L: _emwgpuAdapterRequestDevice,
  /** @export */ a: _emwgpuDelete,
  /** @export */ K: _emwgpuDeviceCreateBuffer,
  /** @export */ J: _emwgpuDeviceCreateShaderModule,
  /** @export */ I: _emwgpuDeviceDestroy,
  /** @export */ H: _emwgpuGetPreferredFormat,
  /** @export */ G: _emwgpuInstanceRequestAdapter,
  /** @export */ F: _emwgpuQueueOnSubmittedWorkDone,
  /** @export */ E: _emwgpuWaitAny,
  /** @export */ s: _fd_close,
  /** @export */ aa: _fd_read,
  /** @export */ $: _fd_seek,
  /** @export */ r: _fd_write,
  /** @export */ D: _wgpuAdapterGetInfo,
  /** @export */ q: _wgpuCommandEncoderBeginComputePass,
  /** @export */ C: _wgpuCommandEncoderBeginRenderPass,
  /** @export */ p: _wgpuCommandEncoderFinish,
  /** @export */ g: _wgpuComputePassEncoderDispatchWorkgroups,
  /** @export */ o: _wgpuComputePassEncoderEnd,
  /** @export */ b: _wgpuComputePassEncoderSetBindGroup,
  /** @export */ f: _wgpuComputePassEncoderSetPipeline,
  /** @export */ B: _wgpuDeviceCreateBindGroup,
  /** @export */ A: _wgpuDeviceCreateBindGroupLayout,
  /** @export */ n: _wgpuDeviceCreateCommandEncoder,
  /** @export */ e: _wgpuDeviceCreateComputePipeline,
  /** @export */ d: _wgpuDeviceCreatePipelineLayout,
  /** @export */ m: _wgpuDeviceCreateRenderPipeline,
  /** @export */ l: _wgpuDeviceCreateTexture,
  /** @export */ z: _wgpuInstanceCreateSurface,
  /** @export */ k: _wgpuQueueSubmit,
  /** @export */ c: _wgpuQueueWriteBuffer,
  /** @export */ y: _wgpuRenderPassEncoderDrawIndirect,
  /** @export */ x: _wgpuRenderPassEncoderEnd,
  /** @export */ j: _wgpuRenderPassEncoderSetBindGroup,
  /** @export */ w: _wgpuRenderPassEncoderSetPipeline,
  /** @export */ i: _wgpuSurfaceConfigure,
  /** @export */ v: _wgpuSurfaceGetCurrentTexture,
  /** @export */ u: _wgpuSurfaceUnconfigure,
  /** @export */ h: _wgpuTextureCreateView
};
