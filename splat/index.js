...
var WebGPU = {
  ...
  makeTexelCopyBufferLayout: ptr => {
    ...
    return {
      "offset": (HEAPU32[(((ptr + 4)) >> 2)] * 4294967296 + HEAPU32[((ptr) >> 2)]),
  ...
  makeRenderPipelineDesc: descriptor => {
    function makePrimitiveState(psPtr) {
      ...
      return {
        "topology": WebGPU.PrimitiveTopology[HEAPU32[(((psPtr) + (4)) >> 2)]],
        "stripIndexFormat": WebGPU.IndexFormat[HEAPU32[(((psPtr) + (8)) >> 2)]],
        "frontFace": WebGPU.FrontFace[HEAPU32[(((psPtr) + (12)) >> 2)]],
        "cullMode": WebGPU.CullMode[HEAPU32[(((psPtr) + (16)) >> 2)]],
    ...
    function makeVertexAttribute(vaPtr) {
      return {
        "format": WebGPU.VertexFormat[HEAPU32[(((vaPtr) + (4)) >> 2)]],
    ...
    function makeVertexBuffer(vbPtr) {
      ...
      return {
        "arrayStride": (HEAPU32[((((vbPtr + 4)) + (8)) >> 2)] * 4294967296 + HEAPU32[(((vbPtr) + (8)) >> 2)]),
        "stepMode": WebGPU.VertexStepMode[stepModeInt],
        "attributes": makeVertexAttributes(attributeCountInt, HEAPU32[(((vbPtr) + (20)) >> 2)])
      };
    }
...
var _emwgpuDeviceCreateBuffer = (devicePtr, descriptor, bufferPtr) => {
  ...
  var desc = {
    ...
    "size": (HEAPU32[((((descriptor + 4)) + (24)) >> 2)] * 4294967296 + HEAPU32[(((descriptor) + (24)) >> 2)]),
...
var _emwgpuWaitAny = (futurePtr, futureCount, timeoutMSPtr) => Asyncify.handleAsync(async () => {
  ...
  for (var i = 0; i < futureCount; ++i) {
    ...
    var futureId = (HEAPU32[((((futurePtr + i * 8) + 4)) >> 2)] * 4294967296 + HEAPU32[(((futurePtr + i * 8)) >> 2)]);
...
var _wgpuCommandEncoderBeginRenderPass = (encoderPtr, descriptor) => {
  ...
  function makeDepthStencilAttachment(dsaPtr) {
    ...
    return {
      ...
      "depthLoadOp": WebGPU.LoadOp[HEAPU32[(((dsaPtr) + (8)) >> 2)]],
      "depthStoreOp": WebGPU.StoreOp[HEAPU32[(((dsaPtr) + (12)) >> 2)]],
      "depthReadOnly": !!(HEAPU32[(((dsaPtr) + (20)) >> 2)]),
      "stencilClearValue": HEAPU32[(((dsaPtr) + (32)) >> 2)],
      "stencilLoadOp": WebGPU.LoadOp[HEAPU32[(((dsaPtr) + (24)) >> 2)]],
      "stencilStoreOp": WebGPU.StoreOp[HEAPU32[(((dsaPtr) + (28)) >> 2)]],
  ...
  function makeRenderPassDescriptor(descriptor) {
    ...
    if (nextInChainPtr !== 0) {
      ...
      maxDrawCount = (HEAPU32[((((renderPassMaxDrawCount + 4)) + (8)) >> 2)] * 4294967296 + HEAPU32[(((renderPassMaxDrawCount) + (8)) >> 2)]);
    }
    var desc = {
      "label": WebGPU.makeStringFromOptionalStringView(descriptor + 4),
...
var _wgpuCommandEncoderWriteTimestamp = (encoderPtr, querySetPtr, queryIndex) => {
  var commandEncoder = WebGPU.getJsObject(encoderPtr);
  var querySet = WebGPU.getJsObject(querySetPtr);
...
var _wgpuDeviceCreateQuerySet = (devicePtr, descriptor) => {
  var desc = {
    "type": WebGPU.QueryType[HEAPU32[(((descriptor) + (12)) >> 2)]],
...
var _wgpuSurfaceConfigure = (surfacePtr, config) => {
  ...
  var configuration = {
    ...
    "alphaMode": WebGPU.CompositeAlphaMode[HEAPU32[(((config) + (40)) >> 2)]]
  };
  ...
  }
  {
    ...
    if (nextInChainPtr !== 0) {
      ...
      configuration.colorSpace = WebGPU.PredefinedColorSpace[HEAPU32[(((surfaceColorManagement) + (8)) >> 2)]];
      configuration.toneMapping = {
        mode: WebGPU.ToneMappingMode[HEAPU32[(((surfaceColorManagement) + (12)) >> 2)]]
      };
    }
  }
...
var _wgpuTextureCreateView = (texturePtr, descriptor) => {
  ...
  if (descriptor) {
    ...
    desc = {
      ...
      "dimension": WebGPU.TextureViewDimension[HEAPU32[(((descriptor) + (16)) >> 2)]],
      "baseMipLevel": HEAPU32[(((descriptor) + (20)) >> 2)],
      "mipLevelCount": mipLevelCount === 4294967295 ? undefined : mipLevelCount,
      "baseArrayLayer": HEAPU32[(((descriptor) + (28)) >> 2)],
      "arrayLayerCount": arrayLayerCount === 4294967295 ? undefined : arrayLayerCount,
      "aspect": WebGPU.TextureAspect[HEAPU32[(((descriptor) + (36)) >> 2)]]
    };
  }
...
var _main, _malloc, _free, _emwgpuCreateBindGroup, _emwgpuCreateBindGroupLayout, _emwgpuCreateCommandBuffer, _emwgpuCreateCommandEncoder, _emwgpuCreateComputePassEncoder, _emwgpuCreateComputePipeline, _emwgpuCreatePipelineLayout, _emwgpuCreateQuerySet, _emwgpuCreateRenderBundle, _emwgpuCreateRenderBundleEncoder, _emwgpuCreateRenderPassEncoder, _emwgpuCreateRenderPipeline, _emwgpuCreateSampler, _emwgpuCreateSurface, _emwgpuCreateTexture, _emwgpuCreateTextureView, _emwgpuCreateAdapter, _emwgpuCreateBuffer, _emwgpuCreateDevice, _emwgpuCreateQueue, _emwgpuCreateShaderModule, _emwgpuOnDeviceLostCompleted, _emwgpuOnMapAsyncCompleted, _emwgpuOnRequestAdapterCompleted, _emwgpuOnRequestDeviceCompleted, _emwgpuOnWorkDoneCompleted, _emwgpuOnUncapturedError, __emscripten_timeout, _memalign, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, dynCall_viiiii, dynCall_viiii, dynCall_viii, dynCall_iiii, dynCall_vi, dynCall_vii, dynCall_jiji, dynCall_ii, dynCall_viji, dynCall_viiiiii, _asyncify_start_unwind, _asyncify_stop_unwind, _asyncify_start_rewind, _asyncify_stop_rewind, memory, __indirect_function_table, wasmMemory;

function assignWasmExports(wasmExports) {
  _main = Module["_main"] = wasmExports["Ba"];
  _malloc = wasmExports["Ca"];
  _free = wasmExports["Da"];
  _emwgpuCreateBindGroup = wasmExports["Ea"];
  _emwgpuCreateBindGroupLayout = wasmExports["Fa"];
  _emwgpuCreateCommandBuffer = wasmExports["Ga"];
  _emwgpuCreateCommandEncoder = wasmExports["Ha"];
  _emwgpuCreateComputePassEncoder = wasmExports["Ia"];
  _emwgpuCreateComputePipeline = wasmExports["Ja"];
  _emwgpuCreatePipelineLayout = wasmExports["Ka"];
  _emwgpuCreateQuerySet = wasmExports["La"];
  _emwgpuCreateRenderBundle = wasmExports["Ma"];
  _emwgpuCreateRenderBundleEncoder = wasmExports["Na"];
  _emwgpuCreateRenderPassEncoder = wasmExports["Oa"];
  _emwgpuCreateRenderPipeline = wasmExports["Pa"];
  _emwgpuCreateSampler = wasmExports["Qa"];
  _emwgpuCreateSurface = wasmExports["Ra"];
  _emwgpuCreateTexture = wasmExports["Sa"];
  _emwgpuCreateTextureView = wasmExports["Ta"];
  _emwgpuCreateAdapter = wasmExports["Ua"];
  _emwgpuCreateBuffer = wasmExports["Va"];
  _emwgpuCreateDevice = wasmExports["Wa"];
  _emwgpuCreateQueue = wasmExports["Xa"];
  _emwgpuCreateShaderModule = wasmExports["Ya"];
  _emwgpuOnDeviceLostCompleted = wasmExports["Za"];
  _emwgpuOnMapAsyncCompleted = wasmExports["_a"];
  _emwgpuOnRequestAdapterCompleted = wasmExports["$a"];
  _emwgpuOnRequestDeviceCompleted = wasmExports["ab"];
  _emwgpuOnWorkDoneCompleted = wasmExports["bb"];
  _emwgpuOnUncapturedError = wasmExports["cb"];
  __emscripten_timeout = wasmExports["db"];
  _memalign = wasmExports["eb"];
  ...
  dynCall_viiiii = dynCalls["viiiii"] = wasmExports["ib"];
  dynCall_viiii = dynCalls["viiii"] = wasmExports["jb"];
  dynCall_viii = dynCalls["viii"] = wasmExports["kb"];
  dynCall_iiii = dynCalls["iiii"] = wasmExports["lb"];
  dynCall_vi = dynCalls["vi"] = wasmExports["mb"];
  dynCall_vii = dynCalls["vii"] = wasmExports["nb"];
  dynCall_jiji = dynCalls["jiji"] = wasmExports["ob"];
  dynCall_ii = dynCalls["ii"] = wasmExports["pb"];
  dynCall_viji = dynCalls["viji"] = wasmExports["qb"];
  dynCall_viiiiii = dynCalls["viiiiii"] = wasmExports["rb"];
  _asyncify_start_unwind = wasmExports["sb"];
  _asyncify_stop_unwind = wasmExports["tb"];
  _asyncify_start_rewind = wasmExports["ub"];
  _asyncify_stop_rewind = wasmExports["vb"];
  memory = wasmMemory = wasmExports["za"];
...
var wasmImports = {
  ...
  /** @export */ xa: ___syscall_openat,
  /** @export */ ra: __abort_js,
  /** @export */ qa: __emscripten_get_last_mouse_event,
  /** @export */ pa: __emscripten_runtime_keepalive_clear,
  /** @export */ oa: __setitimer_js,
  /** @export */ wa: _clock_time_get,
  /** @export */ na: _emscripten_get_gamepad_status,
  /** @export */ ma: _emscripten_get_num_gamepads,
  /** @export */ la: _emscripten_has_asyncify,
  /** @export */ ka: _emscripten_request_pointerlock,
  /** @export */ ja: _emscripten_resize_heap,
  /** @export */ ia: _emscripten_sample_gamepad_data,
  /** @export */ ha: _emscripten_set_fullscreenchange_callback_on_thread,
  /** @export */ ga: _emscripten_set_gamepadconnected_callback_on_thread,
  /** @export */ fa: _emscripten_set_gamepaddisconnected_callback_on_thread,
  /** @export */ ea: _emscripten_set_keydown_callback_on_thread,
  /** @export */ da: _emscripten_set_keyup_callback_on_thread,
  /** @export */ ca: _emscripten_set_main_loop_arg,
  ...
  /** @export */ _: _emscripten_set_orientationchange_callback_on_thread,
  /** @export */ Z: _emscripten_set_pointerlockchange_callback_on_thread,
  /** @export */ Y: _emscripten_set_pointerlockerror_callback_on_thread,
  /** @export */ X: _emscripten_set_resize_callback_on_thread,
  /** @export */ W: _emscripten_set_touchcancel_callback_on_thread,
  /** @export */ V: _emscripten_set_touchend_callback_on_thread,
  /** @export */ U: _emscripten_set_touchmove_callback_on_thread,
  /** @export */ T: _emscripten_set_touchstart_callback_on_thread,
  /** @export */ S: _emscripten_set_wheel_callback_on_thread,
  /** @export */ R: _emwgpuAdapterRequestDevice,
  /** @export */ Q: _emwgpuBufferGetConstMappedRange,
  /** @export */ P: _emwgpuBufferMapAsync,
  /** @export */ O: _emwgpuBufferUnmap,
  /** @export */ a: _emwgpuDelete,
  /** @export */ c: _emwgpuDeviceCreateBuffer,
  /** @export */ f: _emwgpuDeviceCreateShaderModule,
  /** @export */ N: _emwgpuDeviceDestroy,
  /** @export */ M: _emwgpuGetPreferredFormat,
  /** @export */ L: _emwgpuInstanceRequestAdapter,
  /** @export */ w: _emwgpuQueueOnSubmittedWorkDone,
  /** @export */ K: _emwgpuWaitAny,
  /** @export */ x: _fd_close,
  /** @export */ va: _fd_read,
  /** @export */ ua: _fd_seek,
  /** @export */ ta: _fd_write,
  /** @export */ sa: _proc_exit,
  /** @export */ J: _wgpuAdapterGetInfo,
  /** @export */ v: _wgpuCommandEncoderBeginComputePass,
  /** @export */ u: _wgpuCommandEncoderBeginRenderPass,
  /** @export */ I: _wgpuCommandEncoderCopyBufferToBuffer,
  /** @export */ t: _wgpuCommandEncoderFinish,
  /** @export */ H: _wgpuCommandEncoderResolveQuerySet,
  /** @export */ s: _wgpuCommandEncoderWriteTimestamp,
  /** @export */ j: _wgpuComputePassEncoderDispatchWorkgroups,
  /** @export */ r: _wgpuComputePassEncoderEnd,
  /** @export */ d: _wgpuComputePassEncoderSetBindGroup,
  /** @export */ i: _wgpuComputePassEncoderSetPipeline,
  /** @export */ G: _wgpuDeviceCreateBindGroup,
  /** @export */ F: _wgpuDeviceCreateBindGroupLayout,
  /** @export */ q: _wgpuDeviceCreateCommandEncoder,
  /** @export */ h: _wgpuDeviceCreateComputePipeline,
  /** @export */ e: _wgpuDeviceCreatePipelineLayout,
  /** @export */ E: _wgpuDeviceCreateQuerySet,
  /** @export */ p: _wgpuDeviceCreateRenderPipeline,
  /** @export */ D: _wgpuInstanceCreateSurface,
  /** @export */ o: _wgpuQueueSubmit,
  /** @export */ g: _wgpuQueueWriteBuffer,
  /** @export */ C: _wgpuRenderPassEncoderDraw,
  /** @export */ B: _wgpuRenderPassEncoderDrawIndirect,
  /** @export */ n: _wgpuRenderPassEncoderEnd,
  /** @export */ k: _wgpuRenderPassEncoderSetBindGroup,
  /** @export */ m: _wgpuRenderPassEncoderSetPipeline,
  /** @export */ l: _wgpuSurfaceConfigure,
  /** @export */ A: _wgpuSurfaceGetCurrentTexture,
  /** @export */ z: _wgpuSurfaceUnconfigure,
  /** @export */ y: _wgpuTextureCreateView
};
