...
function assignWasmExports(wasmExports) {
  _main = Module["_main"] = wasmExports["ha"];
  _emwgpuCreateBindGroup = wasmExports["ia"];
  _emwgpuCreateBindGroupLayout = wasmExports["ja"];
  _emwgpuCreateCommandBuffer = wasmExports["ka"];
  _emwgpuCreateCommandEncoder = wasmExports["la"];
  _emwgpuCreateComputePassEncoder = wasmExports["ma"];
  _emwgpuCreateComputePipeline = wasmExports["na"];
  _emwgpuCreatePipelineLayout = wasmExports["oa"];
  _emwgpuCreateQuerySet = wasmExports["pa"];
  _emwgpuCreateRenderBundle = wasmExports["qa"];
  _emwgpuCreateRenderBundleEncoder = wasmExports["ra"];
  _emwgpuCreateRenderPassEncoder = wasmExports["sa"];
  _emwgpuCreateRenderPipeline = wasmExports["ta"];
  _emwgpuCreateSampler = wasmExports["ua"];
  _emwgpuCreateSurface = wasmExports["va"];
  _emwgpuCreateTexture = wasmExports["wa"];
  _emwgpuCreateTextureView = wasmExports["xa"];
  _emwgpuCreateAdapter = wasmExports["ya"];
  _emwgpuCreateBuffer = wasmExports["za"];
  _emwgpuCreateDevice = wasmExports["Aa"];
  _emwgpuCreateQueue = wasmExports["Ba"];
  _emwgpuCreateShaderModule = wasmExports["Ca"];
  _emwgpuOnDeviceLostCompleted = wasmExports["Da"];
  _emwgpuOnRequestAdapterCompleted = wasmExports["Ea"];
  _emwgpuOnRequestDeviceCompleted = wasmExports["Fa"];
  _emwgpuOnWorkDoneCompleted = wasmExports["Ga"];
  _emwgpuOnUncapturedError = wasmExports["Ha"];
  _free = wasmExports["Ia"];
  _malloc = wasmExports["Ja"];
  ...
  dynCall_viii = dynCalls["viii"] = wasmExports["Oa"];
  dynCall_iiii = dynCalls["iiii"] = wasmExports["Pa"];
  dynCall_vi = dynCalls["vi"] = wasmExports["Qa"];
  dynCall_viiii = dynCalls["viiii"] = wasmExports["Ra"];
  dynCall_ii = dynCalls["ii"] = wasmExports["Sa"];
  dynCall_viji = dynCalls["viji"] = wasmExports["Ta"];
  dynCall_jiji = dynCalls["jiji"] = wasmExports["Ua"];
  dynCall_viiiiii = dynCalls["viiiiii"] = wasmExports["Va"];
  _asyncify_start_unwind = wasmExports["Wa"];
  _asyncify_stop_unwind = wasmExports["Xa"];
  _asyncify_start_rewind = wasmExports["Ya"];
  _asyncify_stop_rewind = wasmExports["Za"];
  memory = wasmMemory = wasmExports["fa"];
  __indirect_function_table = wasmExports["__indirect_function_table"];
}

var wasmImports = {
  /** @export */ t: ___syscall_fcntl64,
  /** @export */ ea: ___syscall_ioctl,
  /** @export */ da: ___syscall_openat,
  /** @export */ $: __abort_js,
  /** @export */ _: __emscripten_get_last_mouse_event,
  /** @export */ ca: _clock_time_get,
  /** @export */ Z: _emscripten_has_asyncify,
  /** @export */ Y: _emscripten_request_pointerlock,
  /** @export */ X: _emscripten_resize_heap,
  /** @export */ W: _emscripten_set_fullscreenchange_callback_on_thread,
  /** @export */ V: _emscripten_set_keydown_callback_on_thread,
  /** @export */ U: _emscripten_set_keyup_callback_on_thread,
  /** @export */ T: _emscripten_set_main_loop_arg,
  /** @export */ S: _emscripten_set_mousedown_callback_on_thread,
  /** @export */ R: _emscripten_set_mousemove_callback_on_thread,
  /** @export */ Q: _emscripten_set_mouseup_callback_on_thread,
  /** @export */ P: _emscripten_set_pointerlockchange_callback_on_thread,
  /** @export */ O: _emscripten_set_pointerlockerror_callback_on_thread,
  /** @export */ N: _emscripten_set_resize_callback_on_thread,
  /** @export */ M: _emscripten_set_wheel_callback_on_thread,
